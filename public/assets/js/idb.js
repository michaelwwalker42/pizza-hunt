...
// With this uploadPizza() function, we open a new transaction to the database to read the data. Then we access the object store for new_pizza and execute the .getAll() method to it.
